...
flag_organization: "[[ministry-of-intelligence-flag.png]]"
---
...
>
> **Founding Minister:** Antson “Ant” Crazyfoot
>
...
Analysts compare field reports, diplomatic correspondence, maps, trade records, witness accounts, military information, and magical findings. Their task is to distinguish a threat from a rumor and a coincidence from a pattern before either distinction becomes obvious at public expense.

#### Field Service

Field officers gather information beyond the capital and, when necessary, beyond the Republic's borders. The service employs scouts, investigators, couriers, translators, and specialists whose public occupations may be more useful than a formal declaration of espionage.

#### Counterintelligence and Internal Security

This office investigates foreign agents, sabotage, coercive cults, corruption tied to hostile powers, and efforts to steal or manipulate government information. It coordinates with Justice when suspected activity becomes a criminal case and with Magic when the method involves charms, scrying, possession, curses, or planar influence.
...
The minister decides which assessments reach the council, authorizes lawful operations, protects sources, and accepts responsibility for the conclusions presented under the ministry's seal. Permanent staff preserve institutional memory and maintain separate records of confirmed fact, credible assessment, and unresolved possibility.

Public articles should not be treated as complete inventories of the ministry's knowledge. Nor should the absence of a public article be treated as proof that the ministry knows anything at all.

### Relations with Other Offices

The Prime Minister receives the ministry's principal briefings. Defense uses its assessments for planning; Justice supplies legal oversight; Magic investigates supernatural methods and actors; Interior provides geographic and local knowledge; Treasury follows hostile finance and smuggling; and Communication manages the boundary between public warning and protected information.

### Public Contact

Citizens may report suspected espionage, coercion, sabotage, organized smuggling, unusual foreign approaches, or supernatural activity through local authorities or a sealed message to the ministry. A report should identify what was observed, when and where it occurred, and which parts are known directly rather than repeated from another person.
